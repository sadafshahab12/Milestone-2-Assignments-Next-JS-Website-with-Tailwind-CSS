        ...
        <div className="questions lg:px-[10rem] md:px-[2rem] px-[1rem]">
          <div className="accordion border bg-primary text-white rounded">
            <div className="question flex justify-between xs:px-7 px-4 xs:py-4 py-2 rounded-tl rounded-tr">
              <h1 className="xs:text-[1.1rem] text-[0.9rem] font-medium tracking-wide">
                {faqQuestion}
              </h1>
            ...
            <div
              className={`answer bg-black text-white rounded-bl rounded-br transition-all duration-700 ease-in-out ${
                toggle
            ...
            >
              <p className="text-[1rem] px-8 py-5 leading-7 tracking-wide">
                {faqAnswer}
              </p>
            </div>
          </div>
